...
def main():
    prompt_type = 'base'
    model, tokenizer = load_model_tokenizer(f'/data/base_model/Qwen/Qwen3-32B')
    ic(model)
    ...
    copy_all_files(args, '/data/base_model/baseQwen3-32B', dst_dir=args.save_path)
...
def debug():
    ...
    save_path = f'/data/prune/Qwen3-32B/{args.method}_{args.hook_type}_{args.prune_type}_r{args.prune_ratio}_n{args.nsamples}_a{args.alpha}_k{args.kde_nsamples}'
    ...
    copy_all_files(args, '/data/base_model/baseQwen3-32B', dst_dir=save_path)
